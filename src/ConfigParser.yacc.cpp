...
#define yyparse networkd_cfg_yyparse
#define yylex   networkd_cfg_yylex
#define yyerror networkd_cfg_yyerror
#define yylval  networkd_cfg_yylval
#define yychar  networkd_cfg_yychar
#define yydebug networkd_cfg_yydebug
#define yynerrs networkd_cfg_yynerrs
...
# define YYTOKENTYPE
   /* Put the tokens into the symbol table, so that GDB and other debuggers
      know about them.  */
   enum yytokentype {
     CFGT_SECTION_OPEN = 258,
     CFGT_SECTION_CLOSE = 259,
     CFGT_VALUELIST_OPEN = 260,
     CFGT_VALUELIST_DELIMIT = 261,
     CFGT_VALUELIST_CLOSE = 262,
     CFGT_VALUE_ASSIGN = 263,
     CFGT_SEMICOLON = 264,
     CFGT_VALUE_NAME = 265,
     CFGT_STRINGCONSTANT = 266,
     CFGT_NUMBERCONSTANT = 267,
     CFGT_UNEXPECTED = 268
   };
#endif
/* Tokens.  */
#define CFGT_SECTION_OPEN 258
#define CFGT_SECTION_CLOSE 259
#define CFGT_VALUELIST_OPEN 260
#define CFGT_VALUELIST_DELIMIT 261
#define CFGT_VALUELIST_CLOSE 262
#define CFGT_VALUE_ASSIGN 263
#define CFGT_SEMICOLON 264
#define CFGT_VALUE_NAME 265
#define CFGT_STRINGCONSTANT 266
#define CFGT_NUMBERCONSTANT 267
#define CFGT_UNEXPECTED 268
...
/* Line 219 of yacc.c.  */
#line 157 "ConfigParser.yacc.cpp"
...
{
       0,     0,     3,     4,     8,    10,    15,    17,    18,    21,
      24,    29,    31,    33,    35,    39,    41,    43
};

/* YYRHS -- A `-1'-separated list of the rules' RHS. */
static const yysigned_char yyrhs[] =
{
      15,     0,    -1,    -1,    16,    19,     4,    -1,     3,    -1,
      18,     3,    19,     4,    -1,    10,    -1,    -1,    20,    19,
      -1,    17,    19,    -1,    21,     8,    22,     9,    -1,    10,
      -1,    11,    -1,    12,    -1,    23,    24,     7,    -1,     5,
      -1,    22,    -1,    22,     6,    24,    -1
};
...
{
       0,    44,    44,    47,    50,    60,    66,    76,    77,    78,
      81,    86,    94,   101,   108,   111,   116,   117
};
#endif
...
{
  "$end", "error", "$undefined", "CFGT_SECTION_OPEN",
  "CFGT_SECTION_CLOSE", "CFGT_VALUELIST_OPEN", "CFGT_VALUELIST_DELIMIT",
  "CFGT_VALUELIST_CLOSE", "CFGT_VALUE_ASSIGN", "CFGT_SEMICOLON",
  "CFGT_VALUE_NAME", "CFGT_STRINGCONSTANT", "CFGT_NUMBERCONSTANT",
  "CFGT_UNEXPECTED", "$accept", "body", "bodyopening", "section",
  "sectionname", "sectioncontent", "assignment", "assignname", "assignval",
  "assignliststart", "assignlist", 0
};
#endif
...
{
       2,     4,     0,     7,     1,     6,     7,     0,     0,     7,
       0,     9,     7,     3,     8,     0,     0,    15,    12,    13,
       0,     0,     5,    10,    16,     0,     0,    14,    17
};

/* YYDEFGOTO[NTERM-NUM]. */
static const yysigned_char yydefgoto[] =
{
      -1,     2,     3,     6,     7,     8,     9,    10,    24,    21,
      25
};
...
{
      -2,   -11,     3,    -6,   -11,     1,    -6,     7,     8,    -6,
       5,   -11,    -6,   -11,   -11,    -5,    10,   -11,   -11,   -11,
       2,    -5,   -11,   -11,     9,    11,    -5,   -11,   -11
};

/* YYPGOTO[NTERM-NUM].  */
static const yysigned_char yypgoto[] =
{
     -11,   -11,   -11,   -11,   -11,    -4,   -11,   -11,     4,   -11,
     -10
};
...
{
      17,     1,    11,     4,     5,    14,    18,    19,    16,   -11,
      12,    23,    13,    15,    22,    26,    28,     0,    27,    20
};

static const yysigned_char yycheck[] =
{
       5,     3,     6,     0,    10,     9,    11,    12,    12,     8,
       3,     9,     4,     8,     4,     6,    26,    -1,     7,    15
};
...
{
       0,     3,    15,    16,     0,    10,    17,    18,    19,    20,
      21,    19,     3,     4,    19,     8,    19,     5,    11,    12,
      22,    23,     4,     9,    22,    24,     6,     7,    24
};
...
/* Line 1126 of yacc.c.  */
#line 1238 "ConfigParser.yacc.cpp"

  yyvsp -= yylen;
  yyssp -= yylen;
